...
from data.cub_dataset import (ImageBubbleFolder, PairedTransforms,
...
if args.dataset == "cifar10":
    ...
    img_transform = transforms.Compose([
        ...
        transforms.ToTensor(),
        transforms.Normalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225]),  # 画像にはNormalizeを適用
    ])
    ...
    bubble_transform = transforms.Compose([
        ...
        transforms.ToTensor(),  # ここではNormalizeを適用しない
    ])
